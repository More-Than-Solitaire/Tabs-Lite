...
@Composable
fun TabTopAppBar(tab: TabFullWithPlaylistEntry) {
    ...
    MediumTopAppBar(
        ...
        actions = {
            IconButton(onClick = {
                ...
                Icon(
                    imageVector = ImageVector.vectorResource(if (isFavorite) R.drawable.ic_favorite else R.drawable.ic_unfavorite),
